  ...
  return (
    <div className={`${style.container} ${theme === "dark" ? style.dark : ""}`}>
      ...
      <AnimatedSections>
        ...
        {/* DigitalExperience */}
        <section className={style.digitalexperience}>
          ...
          <div className={style.maingrid}>
            ...
            <div className={style.contentdiv}>
              <p>
                Lorem ipsum dolor sit amet consectetur. Lobortis sed convallis
                vitae velit ultricies tellus vitae integer. Ipsum tincidunt non
                commodo dictumst ultricies in. Aliquet in non sed faucibus purus
                felis sed vitae. Commodo nisi in lectus dolor ipsum eget
                venenatis quisque amet. Semper enim dictum a cras scelerisque
                libero pellentesque potenti sollicitudin. Semper donec
                phasellus.
              </p>
        ...
        <section className={style.evolution}>
          <div className={style.evolutioncontainer}>
            ...
            <p>
              ...
              vitae velit ultricies tellus vitae integer. Ipsum tincidunt non
              commodo dictumst ultricies in. Aliquet in non sed faucibus purus
              felis sed vitae. Commodo nisi in lectus dolor ipsum eget venenatis
              quisque amet. Semper enim dictum a cras scelerisque libero
              pellentesque potenti sollicitudin. Semper donec phasellus.
            </p>
              ...
              <div className={style.dotswrapper}>
                {Evolution.map((item, index) => (
                  <div
                    key={index}
                    className={
                      openIndex === index ? style.bluedots : style.dots
                    }
        ...
        <section className={style.ourvalues}>
          ...
          <div className={style.valuesgrid}>
            <div className={style.valuecard}>
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur. Lobortis sed convallis
                vitae velit ultricies tellus vitae integer.
              </p>
            </div>
            <div className={style.valuecard}>
              <svg
                ...
                <defs>
                  <clipPath id="clip0_4141_12459">
                    <rect
                      ...
                      height={47}
                      fill="white"
                      transform="translate(0.339844 0.681641)"
                    />
                  </clipPath>
                </defs>
              </svg>
                ...
                <defs>
                  <clipPath id="clip0_4141_12468">
                    <rect
                      ...
                      height={47}
                      fill="white"
                      transform="translate(0.0957031 0.681641)"
                    />
                  </clipPath>
                </defs>
              </svg>
