    ...
    <div className={`${style.container} ${theme === "dark" ? style.dark : ""}`}>
      ...
      <AnimatedSections>
        ...
        <section className={style.services}>
          <div className={style.Designservice}>
          ...
          <div className={style.otherservices}>
            <div className={style.servicescontent}>
              ...
              <p>
                ...
                aliquet pellentesque vitae. Nulla risus fusce aliquam sed
                natoque neque.
              </p>
            </div>
            <div className={style.imagewrapper}>
              ...
              >
                ...
                <path
                  d="M35.1801 17.0358H21.5738V18.9543L31.8942 18.9611L18.1722 32.683L19.5329 34.0437L33.2548 20.3217L33.2616 30.6421H35.1801V17.0358Z"
                  fill="white"
                />
              </svg>
            </div>
          ...
          <div className={style.otherservices}>
            <div className={style.servicescontent}>
              <h1>SEA (Search Engine Advertisement)</h1>
              <p>
                Lorem ipsum dolor sit amet consectetur. Ultrices convallis quam
                euismod viverra nisi malesuada venenatis. Vulputate adipiscing
                aliquet pellentesque vitae. Nulla risus fusce aliquam sed
          ...
          <div className={style.line}></div>
          <div className={style.otherservicesmore}>
            <div className={style.servicescontent}>
              <h1>Social</h1>
              <div>
                <p>
                  Lorem ipsum dolor sit amet consectetur. Ultrices convallis
                  quam euismod viverra nisi malesuada venenatis. Vulputate
                  adipiscing aliquet pellentesque vitae. Nulla risus fusce
                  aliquam sed natoque neque.
                </p>
          ...
          <div className={style.otherservicesmore}>
            <div className={style.servicescontent}>
              ...
              <div>
                ...
                <h2>Insights for optimisation</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur. Ultrices convallis
                  quam euismod viverra nisi malesuada venenatis. Vulputate
                  adipiscing aliquet pellentesque vitae. Nulla risus fusce
        ...
        <section className={style.marketing}>
          <div className={style.marketingmain}>
            <h1>Smarter Marketing Powered by AI</h1>
            <p>
              Revolutionize Your Marketing Strategy with Intelligent Insights
            </p>
            <div className={style.Aigrid}>
              <div className={style.marketingcontent}>
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#2181F0" />
                      <stop offset={1} stopColor="#E2EFFD" />
                    </linearGradient>
                  </defs>
                </svg>
                ...
                <div>
                  ...
                  <p>Make datadriven decisions with AI insights.</p>
                </div>
              </div>
              <div className={style.marketingcontent}>
                <svg
                ...
                >
                  <circle
                    ...
                    cy="33.3884"
                    r={33}
                    fill="url(#paint0_linear_4126_29583)"
                    fillOpacity="0.3"
                  />
                  <path
                    d="M33.4159 27.6905C36.14 27.6905 38.3484 25.703 38.3484 23.2512C38.3484 20.7995 36.14 18.812 33.4159 18.812C30.6917 18.812 28.4834 20.7995 28.4834 23.2512C28.4834 25.703 30.6917 27.6905 33.4159 27.6905Z"
                    stroke="#2181F0"
                    strokeWidth="1.45662"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M27.4971 38.5415H21.5781C19.9437 38.5415 18.6187 39.7782 18.6187 41.3037V42.6848C18.6187 44.2103 19.9437 45.447 21.5781 45.447H27.4971C29.1316 45.447 30.4566 44.2103 30.4566 42.6848V41.3037C30.4566 39.7782 29.1316 38.5415 27.4971 38.5415Z"
                    stroke="#2181F0"
                    strokeWidth="1.45662"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M45.2539 38.5415H39.335C37.7005 38.5415 36.3755 39.7782 36.3755 41.3037V42.6848C36.3755 44.2103 37.7005 45.447 39.335 45.447H45.2539C46.8884 45.447 48.2134 44.2103 48.2134 42.6848V41.3037C48.2134 39.7782 46.8884 38.5415 45.2539 38.5415Z"
                    stroke="#2181F0"
                    strokeWidth="1.45662"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M24.5376 38.5413V35.5818C24.5376 34.7969 24.8494 34.0441 25.4044 33.4891C25.9594 32.9341 26.7122 32.6223 27.4971 32.6223H39.335C40.1199 32.6223 40.8727 32.9341 41.4277 33.4891C41.9827 34.0441 42.2945 34.7969 42.2945 35.5818V38.5413"
                    stroke="#2181F0"
                    strokeWidth="1.45662"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <div>
                  ...
                  <p>Save time with intelligent automation.</p>
                </div>
              </div>
              ...
              <div className={style.marketingcontent}>
                ...
                <div>
                  ...
                  <p>Monitor and adjust campaigns instantly.</p>
                </div>
              </div>
              ...
              <div className={style.marketingcontent}>
                ...
                <div>
                  ...
                  <p>Deliver tailored experiences to your audience.</p>
                </div>
              </div>
            </div>
