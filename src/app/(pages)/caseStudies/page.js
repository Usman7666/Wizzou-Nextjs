  ...
  return (
    <div className={`${style.container} ${theme === "dark" ? style.dark : ""}`}>
      ...
      <AnimatedSections>
        ...
        {/* OurWork */}
        <section className={style.OurWorkSection}>
          ...
          <div className={style.OurWorkgrid}>
            <div className={style.card}>
              <div className={style.imagewrapper}>
                <button className={style.marketingbutton}>Marketing</button>
                <Image
              ...
              <h2>Lorem ipsum dolor sit amet consectetur. Ornare.</h2>
              <p>
          ...
          <button className={style.seemorebutton}>See More Case Studies</button>
        </section>
