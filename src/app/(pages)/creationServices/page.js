  ...
  return (
    <div className={`${style.container} ${theme === "dark" ? style.dark : ""}`}>
      ...
      <AnimatedSections>
        ...
        <section className={style.heroSection}>
          ...
          <div>
            <div className={style.herowrapper}>
              <h2>
                From stunning designs to powerful development—your one-stop
                solution for websites, applications, branding, and more.
              </h2>
              <div>
                <svg
        ...
        {/* Development */}
        <section className={style.developmentSection}>
          <h1>Development</h1>
          <p>
