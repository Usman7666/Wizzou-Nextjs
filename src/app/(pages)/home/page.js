...
export default function HomePage() {
  ...
  return (
    <div className={`${theme === "dark" ? style.dark : ""} ${style.container}`}>
      ...
      <AnimatedSections>
        {/* Hero Section */}
        <section className={`${style.herosection} ${style.sectionAnimation}`}>
        ...
        {/* BlueSection */}
        <section className={style.blueSection}>
          <div className={style.bluemain}>
            <div className={style.divtop}>
              ...
              <p>
                ...
                thrive in a fast-paced digital world. Our team combines
                innovation, strategy, and technology to deliver tailored
                solutions that drive results and foster growth.
              </p>
            </div>
        ...
        {/* 500+Projects */}
        <section className={style.fivehundred}>
          <div className={style.fivehundredmain}>
            ...
            <div>
              ...
              <p>
                ...
                Poliitet jymäde ekotes. Sonera håtär men kavar för dock
              </p>
