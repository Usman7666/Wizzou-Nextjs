      ...
      <AnimatedSections>
        ...
        <section className={style.heroSection}>
          ...
          <div>
            ...
            <div className={style.herowrapper}>
              <h2>
                Lorem ipsum dolor sit amet consectetur. Tincidunt leo nulla
                mauris vel velit fermentum fusce lectus arcu. Tempor proin vel
                velit fermentum fusce lectus arcumalesuada volutpat vestibulum.
              </h2>
              <div>
                <svg
        ...
        <section className={style.Expertise}>
          ...
          <div className={style.expertiseContent}>
            ...
            <div className={style.expertiselist}>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={91}
